    ...
    <header className="fixed top-0 left-0 m-auto max_padd_container w-full bg-white ring-1 ring-slate-900/5 z-10 ">
      <div className="px-4 flexBetween py-3 max-xs:px-2">
        ...
        <Navbar
          containerStyles={`${
            menuOpened
              ? "flex item-start flex-col gap-y-6 fixed top-20 right-5 p-12 bg-white rounded-3xl shadow-md w-64 medium-16 ring-1 ring-slate-900/5 transition-all duration-300"
        ...
        <div className="flexBetween sm:gap-x-6 bold-16">
          ...
          <div className="flexBetween cursor-pointer sm:gap-x-6">
            ...
            <NavLink to={'logout'} className={"btn_secondary_rounded flexCenter"}><img src={logout}/>Logout</NavLink>
          </div>
        </div>
      </div>
    </header>
