...
const Navbar = ({containerStyles}) => {
  return (
    ...
    <NavLink to={'/about'} className={({isActive})=> isActive ? "active_link" : ""}><div className="flexCenter gap-x-1">About Us</div></NavLink>
    <NavLink to={'/contact'} className={({isActive})=> isActive ? "active_link" : ""}><div className="flexCenter gap-x-1">Contact Us</div></NavLink>
